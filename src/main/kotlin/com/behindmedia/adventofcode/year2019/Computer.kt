...
import com.behindmedia.adventofcode.common.toMutableMap
...
class Computer(initialState: List<Long>) {
    ...
    constructor(encodedInitialState: String): this(
        parseEncodedState(
            encodedInitialState
        )
    )
    ...
    /**
     * Returns the current state of the computer as com.behindmedia.adventofcode.year2018.read-com.behindmedia.adventofcode.year2018.only map: <address, value>
     */
    ...
    fun process(inputs: List<Long>): Result {
        ...
        while (true) {
            val opcode =
                Opcode.atCurrentPosition(this)
            val operation =
                Operation.forCode(opcode.code)
    ...
    private sealed class Operation {
         ...
         *
         * An address is different from a plain value in that it com.behindmedia.adventofcode.year2018.only supports operand modes 0 and 2.
         */
