...
class LazySegmentTreeAssignmentTest: AbstractSegmentTreeTest() {
    ...
    fun testSingleElementArray() {
        ...
        st.update(0..0, 100, Operation.Assign)
    ...
    fun testFullRangeAssignment() {
        ...
        // sum => 10 * 5 = 50
        st.update(0..4, 10, Operation.Assign)
    ...
    fun testPartialRangeAssignment() {
        ...
        st.update(1..3, 7, Operation.Assign)

        // sum(0..4) => 1+7+7+7+5 = 27

        for (i in 0..4) {
            println(st.query(i).value)
        }
    ...
    fun testOverlapAssignments() {
        ...
        st.update(0..2, 3, Operation.Assign)
        assertEquals(9, st.query(0..4).value)

        // Assign 5 to [1..4] => array => [3,5,5,5,5]
        st.update(1..4, 5, Operation.Assign)
